...
Only publish the source files, generated app icon, build files, README, license, and `.gitignore`.

Do not publish:

- Official Aula/Epomaker driver installers
- Extracted DLLs, XML, GIFs, images, fonts, or other official assets
- Homebrew bottle/cache folders used during reverse engineering
- Local test media or generated build output
